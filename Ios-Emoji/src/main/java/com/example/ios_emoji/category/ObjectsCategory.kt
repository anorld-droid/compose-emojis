...
class ObjectsCategory : IosEmojiCategory {
    override val emojis: Array<IosEmoji>
        get() = EMOJIS

    @get:DrawableRes
    override val icon: Int
        get() = R.drawable.emoji_ios_category_objects

    @get:StringRes
    override val categoryName: Int
        get() = R.string.emoji_ios_category_objects

    companion object {
        private val EMOJIS: Array<IosEmoji> = CategoryUtils.concatAll(ObjectsCategoryChunk0.get())
    }
}