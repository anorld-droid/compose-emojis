...
class TravelAndPlacesCategory : IosEmojiCategory {
    override val emojis: Array<IosEmoji>
        get() = EMOJI
    @get:DrawableRes
    override val icon: Int
        get() = R.drawable.emoji_ios_category_travelandplaces

    @get:StringRes
    override val categoryName: Int
        get() = R.string.emoji_ios_category_travelandplaces

    companion object {
        private val EMOJI = concatAll(TravelAndPlacesCategoryChunk0.get())
