...
class SymbolsCategory : IosEmojiCategory {
    override val emojis: Array<IosEmoji>
        get() = EMOJIS

    @get:DrawableRes
    override val icon: Int
        get() = R.drawable.emoji_ios_category_symbols

    @get:StringRes
    override val categoryName: Int
        get() = R.string.emoji_ios_category_symbols

    companion object {
        private val EMOJIS: Array<IosEmoji> = CategoryUtils.concatAll(SymbolsCategoryChunk0.get())
    }
}